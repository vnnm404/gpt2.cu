...
// b: [output_dim]
// Launch with: dim3 grid((output_dim + TILE_SIZE - 1) / TILE_SIZE, (batch_size
// * seq_len + TILE_SIZE - 1) / TILE_SIZE);
//              dim3 block(TILE_SIZE * TILE_SIZE);
__global__ void mlp_forward(float *out, const float *input, const float *w,
                            const float *b, int batch_size, int seq_len,
...
// Launch with: dim3 grid((input_dim + TILE_SIZE - 1) / TILE_SIZE, (batch_size *
// seq_len + TILE_SIZE - 1) / TILE_SIZE);
//              dim3 block(TILE_SIZE * TILE_SIZE);
__global__ void mlp_backward_input(float *g_input, const float *g_out,
...
// Launch with: dim3 grid((output_dim + TILE_SIZE - 1) / TILE_SIZE, (input_dim +
// TILE_SIZE - 1) / TILE_SIZE);
//              dim3 block(TILE_SIZE * TILE_SIZE);
__global__ void mlp_backward_weight(float *g_weight, float *g_bias,
