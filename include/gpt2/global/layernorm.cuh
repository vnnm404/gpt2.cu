...
// gamma: [n_embd]
// beta: [n_embd]
__global__ void layernorm_forward(float *out, float *input, float *weight,
                                  float *bias, float *ln_mean, float *ln_rstd,
...
// weight: [n_embd]
__global__ void layernorm_backward(float *g_input, float *g_weight,
                                   float *g_bias, const float *g_out,
                                   const float *input, const float *weight,
                                   const float *ln_mean, const float *ln_rstd,
