...
__device__ void embedding_forward_device(float *out, const int *input_tokens,
                                         const float *wte, const float *wpe,
                                         int seq_len, int n_embd,
                                         int vocab_size, int n_positions,
                                         int blockIdx_x) {
...
__device__ void embedding_backward_device(float *g_wte, float *g_wpe,
                                          const float *g_out, const int *inp,
                                          int B, int T, int C, int blockIdx_x) {
