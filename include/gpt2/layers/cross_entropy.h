...
__global__ void cross_entropy_backward_init(float *dlosses, int batch_size, int seq_len);
__global__ void cross_entropy_backward(float *dlogits, float *dlosses, float *probs, const int *targets, int batch_size, int seq_len, int vocab_size);
